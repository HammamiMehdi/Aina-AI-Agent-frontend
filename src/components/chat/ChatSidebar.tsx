        ...
        <div className="space-y-1">
          {groupConvs.map((conv) => (
            <div
              ...
              className={`group p-2 rounded-lg cursor-pointer transition-all relative flex items-center min-h-[40px] ${
              ...
              {renamingId === conv.conversation_id ? (
                ...
                <>
                  ...
                  <div className="flex-1 flex items-center justify-between pr-8">
                    ...
                    <h3 
                      className={`text-xs truncate flex-1 text-left leading-relaxed ${
                        activeConversation === conv.conversation_id
    ...
    <>
      <AnimatePresence>
        ...
        <motion.div
          ref={sidebarRef}
          initial={{ x: 0 }}
          animate={{ x: isOpen ? 0 : '-95%' }} // 20% visible quand fermé
          exit={{ x: 0 }}
        ...
        >
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-tr-2xl relative">
